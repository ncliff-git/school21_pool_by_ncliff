...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/08/06 18:19:45 by mjacqual          #+#    #+#             */
/*   Updated: 2020/08/06 18:23:51 by mjacqual         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		main(int argc, char **argv)
{
	...
	printf("last element argv %s\n", ft_list_last(begin)->data);
	printf("last element empty list %s\n", ft_list_last(new)->data);
	return (0);
}
